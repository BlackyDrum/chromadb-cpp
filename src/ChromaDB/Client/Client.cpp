...
namespace chromadb {
    ...
    Client::Client(const std::string& scheme, const std::string& host, const std::string& port, const std::string& database, const std::string& tenant)
        : m_ChromaApiClient(scheme, host, port), m_Database(database), m_Tenant(tenant)
    {
        this->Initialize();
    }
