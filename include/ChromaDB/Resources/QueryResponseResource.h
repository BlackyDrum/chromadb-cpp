...
namespace chromadb {
    ...
    struct QueryResponseResource
    {
        ...
        QueryResponseResource(const std::vector<std::string>& ids, std::shared_ptr<const std::vector<std::vector<double>>> embeddings = nullptr, std::shared_ptr<const std::vector<std::unordered_map<std::string, std::string>>> metadatas = nullptr, std::shared_ptr<const std::vector<std::string>> documents = nullptr, std::shared_ptr<const std::vector<double>> distances = nullptr)
